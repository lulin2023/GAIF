...
table(data1$is_pass)/nrow(data1)
...
candidate <- ggarrange(P1, P2, ncol=2, nrow=1, common.legend = TRUE, legend="bottom",
                          font.label = list(size = 20, face = "bold"))

pdf(file = "candidate.pdf",width = 10,height = 4) 
candidate
dev.off()
...
pp_subset$Method <- factor(pp_subset$Method, levels = c("Opt-SF", "Opt-LF", "Opt-SFS", "Opt-LFS", "SAFFRON", "LORD++","LOND"))
